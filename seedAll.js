 ...
 * Цель этого кода это автомизации выполния сидов в правильном порядке
 * У меня была проблема с сидерами из за того что они запускались не в том порядке (неправильно их создал). Прибегнул к помощи от ИИ, он помог, но не без ошибок.
 * Итог: всё работает(пока что)
